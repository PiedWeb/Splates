...
$templates = new PiedWeb\Splates\Engine('/path/to/templates');

// Add any additional folders
$templates->addFolder('emails', '/path/to/emails');

// Load any additional extensions
$templates->loadExtension(new PiedWeb\Splates\Extension\Asset('/path/to/public'));
...
class Controller
{
    ...
    public function __construct(PiedWeb\Splates\Engine $templates)
    {
